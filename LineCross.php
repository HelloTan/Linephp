...
Class AuthInfo {
    ...
    public $Name;
    public $Rev;
    public function __construct($Token = NULL,$Mail = NULL, $Pass = NULL, $Cert = NULL,  $Name = "Line Tanysyz", $Rev = NULL) {
        $this->Mail = $Mail;
        $this->Pass = $Pass;
        $this->Cert = $Cert;
        $this->Token = $Token;
...
class AppType {
    public $IOS_UA = 'iPad:4,1(10.12.0)';
    public $IOS_APP = 'IOSIPAD 7.14.0 iPhone OS 10.12.0';
    public $UA;
    public $APP;
    public function __construct() {
        $this->UA = $this->IOS_UA;
        $this->APP = $this->IOS_APP;
    }
}
class ServiceInfo {
    public $Host;
